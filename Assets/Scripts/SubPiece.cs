...
public class SubPiece : MonoBehaviour
{
    ...
    public void SetPiece()
    {
        ...
        {
            //randomColor = Random.Range(0, ClipManager.instance.colorsToMats.Length - 1);
            randomColor = Random.Range(0, GameManager.instance.currentMap.levelAvailableColors.Length);
            colorOfPiece = (PieceColor)randomColor;

            //randomSymbol = Random.Range(0, ClipManager.instance.colorsToMats[randomColor].colorTex.Length);
            randomSymbol = Random.Range(0, GameManager.instance.currentMap.levelAvailableSymbols.Length);
            ...
            //r.GetPropertyBlock(mpb);
            //mpb.SetTexture("_BaseMap", ClipManager.instance.colorsToMats[randomColor].colorTex[randomSymbol]);
            //r.SetPropertyBlock(mpb);

            //rend.material = ClipManager.instance.colorsToMats[randomColor].colorTex[randomSymbol];
            //rend.material.SetTexture("Tile_Albedo_Map", ClipManager.instance.colorsToMats[randomColor].colorTex[randomSymbol]);
            //rend.material.SetTexture("MatchedSymbolTex", ClipManager.instance.symbolToMat[randomSymbol].symbolTex);
