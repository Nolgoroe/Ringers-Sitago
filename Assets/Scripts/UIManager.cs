...
public class UIManager : MonoBehaviour
{
    ...
    public IEnumerator FadeIntoLevelAction()
    {
        ...
        LeanTween.value(fadeIntoLevelScreen, 0, 1, fadeIntoLevelSpeed).setEase(LeanTweenType.linear).setOnComplete(() => GameManager.instance.ResetDataStartLevel()).setOnUpdate((float val) =>
        {
